    ...
    <div className="min-h-screen bg-background selection:bg-primary/20">
          ...
          <div className="flex flex-col-reverse md:flex-row items-center gap-12 md:gap-24">
            ...
            >
              <div className="space-y-4">
                <Badge
                  variant="outline"
                  className="px-4 py-1.5 text-sm border-primary/20 text-primary bg-primary/5 rounded-full"
                >
                ...
                <p className="text-xl md:text-2xl text-muted-foreground font-medium max-w-2xl mx-auto md:mx-0">
                  AIML & Cybersecurity Enthusiast | Exploring GenAI | Full Stack
                  Developer
                </p>
              </div>
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-4">
                <Button
                  size="lg"
                  className="rounded-full bg-gradient-primary shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all hover:-translate-y-0.5"
                  asChild
                >
              ...
              <div className="flex items-center justify-center md:justify-start gap-6 pt-4 text-muted-foreground">
                <a
                  href="https://github.com/VedantGorule"
                  target="_blank"
                ...
                <a
                  href="https://linkedin.com/in/vedant-gorule"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-foreground transition-colors"
                >
                ...
                <a
                  href="mailto:vedant.gorule@gmail.com"
                  className="hover:text-foreground transition-colors"
                >
                  <Mail size={24} />
                </a>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              I'm an AIML & Cybersecurity enthusiast and a Computer Engineering
              undergraduate at Nutan Maharashtra Institute of Engineering and
              Technology. I have hands-on experience in web development, cloud
              computing, and secure application design. Passionate about coding
              ...
              <CardContent className="p-8">
                ...
                <ul className="space-y-3 text-muted-foreground">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      Designed responsive web interfaces using HTML, CSS,
                  ...
                  <li className="flex items-start gap-3">
                    <span className="mt-2 w-1.5 h-1.5 rounded-full bg-primary flex-shrink-0" />
                    <span>
                      Improved user engagement by 30% and load time by 20%
                  ...
                  <li className="flex items-start gap-3">
                    <span className="mt-2 w-1.5 h-1.5 rounded-full bg-primary flex-shrink-0" />
                    <span>
                      Optimized adaptive layouts increasing mobile traffic by
                      25%.
                    </span>
                  </li>
                </ul>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16 space-y-4">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              A selection of projects exploring AI, Blockchain, and Cloud
              Architecture.
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-start">
            <div className="md:w-1/3 space-y-6">
              ...
              <p className="text-muted-foreground">
                I'm constantly learning and expanding my tech stack. Here are
            ...
            <div className="p-8 md:p-12 bg-primary text-primary-foreground flex flex-col justify-between">
              <div className="space-y-6">
                ...
                <p className="text-primary-foreground/80 text-lg">
                  Have a project in mind or just want to chat about AI and
                ...
                <div className="space-y-4 mt-8">
                  <a
                    href="mailto:vedant.gorule@gmail.com"
                    className="flex items-center gap-3 text-lg hover:underline underline-offset-4"
                  >
      ...
      <footer className="py-8 bg-background border-t border-border">
        <div className="container mx-auto px-4 text-center text-muted-foreground">
          <p>
            © {new Date().getFullYear()} Vedant Gorule. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
